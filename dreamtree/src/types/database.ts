...
export type BlockType = 'content' | 'prompt' | 'tool';
...
export type InputType = 'text_input' | 'textarea' | 'slider' | 'checkbox' | 'checkbox_group' | 'radio' | 'select';

export interface Prompt {
  id: number;
  prompt_text: string;
  input_type: InputType;
  input_config: string | null; // JSON
  version: number;
  is_active: number;
}
